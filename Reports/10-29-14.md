...
- Created a leaf function to indentify leaf node for test data
  Commits: 
  [1](https://github.com/ai-se/george/commit/285d7796d70f02e8e9824ed665623f9892a75d87)<br/>
  Code: <br/>
  ```python
  def leaf(m,one,node):
  if node._kids:
...
- Built a Test Rig using similar grounds of _loo in [what.py]()<br/>
  Commits: [1](https://github.com/ai-se/george/commit/7d48df95fd9168858def4f28527f748677621391)<br/>
  Files: (testRig.py)[https://github.com/ai-se/where/blob/master/what.py]
